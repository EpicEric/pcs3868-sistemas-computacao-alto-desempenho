...
#define Semaph sem_t
#include "type_soma-vet.h"  /* typedef's */
#include "vgp_soma-vet.h"   /* global privada*/
#include "vsl_soma-vet.h"   /* shared local  */
#include "partask_soma-vet.h"
